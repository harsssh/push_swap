...
/*   Updated: 2023/06/15 03:37:15 by kemizuki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	stacks_add_instruction(stacks, INST_RA);
...
{
	stacks_add_instruction(stacks, INST_RB);
	rotate_impl(stacks->b);
}

void	stacks_rr(t_stacks *stacks)
{
	stacks_add_instruction(stacks, INST_RR);
	rotate_impl(stacks->a);
	rotate_impl(stacks->b);
}
